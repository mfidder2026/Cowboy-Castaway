...
/* Left-facing fire animations (mirrored) */
#define FX_LFIRE0      36       /* FX_FIRE0 gespiegeld (links)              */
#define FX_LFIRE1      37       /* FX_FIRE1 gespiegeld (links)              */
#define FX_LFIRE2      38       /* FX_FIRE2 gespiegeld (links)              */
#define FX_LFIRE3      39       /* FX_FIRE3 gespiegeld (links)              */
#define FX_LFIRE4      40       /* FX_FIRE4 gespiegeld (links)              */
#define FX_LFIRE5      41       /* FX_FIRE5 gespiegeld (links)              */
